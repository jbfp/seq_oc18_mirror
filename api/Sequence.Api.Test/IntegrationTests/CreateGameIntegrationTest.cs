...
namespace Sequence.Api.Test.IntegrationTests
{
    public sealed class CreateGameIntegrationTest : IntegrationTestBase
    {
        ...
        public CreateGameIntegrationTest(WebApplicationFactory<Startup> factory) : base(factory)
        {
        }
        ...
        public async Task RoutesAreProtected()
        {
            ...
            using (var response = await UnauthorizedClient.PostAsJsonAsync("/games", body))
            {
        ...
        {
            return await AuthorizedClient.PostAsJsonAsync(BasePath, value);
        }
    }
}
