...
BEGIN
    ...
    , CASE WHEN ge.id IS NULL THEN g.player1 ELSE ge.next_player_id END AS next_player_id
...
INSERT INTO public.migration (name) VALUES ('20181217174021_update_game_list_view_2');
